...
class Scene:
    ...
    def __init__(self, args : ModelParams, pose_args : GenerateCamParams, gaussians : GaussianModel, load_iteration=None, shuffle=False, resolution_scales=[1.0], ifeva=0,h=0):
        """b
        ...
        self.test_cameras = {}
        scene_info = sceneLoadTypeCallbacks["RandomCam"](self.model_path ,pose_args,ifeva,h=h)
    ...
    def getRandTrainCameras(self,height,scale=1.0):
        iteration = self.iteration
        rand_train_cameras = GenerateRandomCameras(height,self.pose_args, self.args.batch, SSAA=True,iteration=iteration)
        train_cameras = {}
